...
always_comb begin
	case (imm_sel)
		...
		IMM_B: immediate = {{19{instruction[31]}}, instruction[7], instruction[30:25], instruction[11:8], 1'b0};
		IMM_U: immediate = {instruction[31:12], 12'b0};
		IMM_J: immediate = {{11{instruction[31]}}, instruction[19:12], instruction[20], instruction[30:21], 1'b0};
